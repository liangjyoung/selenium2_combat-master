...
public class TestngRetry implements IRetryAnalyzer {
   ...
   // private static Logger logger = Logger.getLogger(TestngRetry.class);
    private int retryCount = 1;    //定义重跑的次数
    ...
    static {
        ...
        FileHelper.info("RetryCount=" + maxRetryCount);
        FileHelper.info("SourceDir=" + config.getSourceCodeDir());
        FileHelper.info("SourceEncoding=" + config.getSrouceCodeEncoding());
    }
